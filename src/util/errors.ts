...
export enum ErrorMessage {
  ...
  NO_RELAYER_FEE = 'No Broadcaster Fee included in transaction.',
  ...
  RELAYER_OUT_OF_GAS = 'Broadcaster is out of gas, or currently does not have enough to process this transaction.',
